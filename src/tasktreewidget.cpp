...
TaskTreeWidget::TaskTreeWidget(QWidget *parent) : QTreeWidget(parent)
{
...
void TaskTreeWidget::set_channel_status(int channel, bool flag)
{
    channels_.at(channel)->setEnabled(flag);
}

void TaskTreeWidget::OnCustomContextMenuRequested(const QPoint &pos)
{
